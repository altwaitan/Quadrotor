...
public:
  ...
  fame_log()
  {
    sub = n.subscribe<fame::fame_state>("/fame_trajectory_2", 1000, &fame_log::callback, this);
    sub2 = n.subscribe<fame::fame_state>("/fame_state_2", 1000, &fame_log::callback2, this);
    sub3 = n.subscribe<fame::fame_msg>("/fame_cmd_2", 1000, &fame_log::callback3, this);
  }
...
{
  datafile.open("/home/smanne1/catkin_ws/src/fame/vehicle2_data.txt");
  ros::init(argc, argv, "fame_log_2");
  fame_log fame;
