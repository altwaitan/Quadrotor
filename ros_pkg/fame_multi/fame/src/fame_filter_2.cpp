...
public:
  ...
  fame_filter()
  {
    sub = n.subscribe<sensor_msgs::Imu>("/fame_serial_imu_2", 1000, &fame_filter::callback, this);
    sub2 = n.subscribe<nav_msgs::Odometry>("/vive/LHR_FC64C5CA_odom", 1000, &fame_filter::callback2, this);
    sub3 = n.subscribe<fame::fame_state>("fame_state", 1000, &fame_filter::callback3, this);
    pub = n.advertise<fame::fame_state>("fame_state_2", 1000);
  }
  ...
  void callback3(const fame::fame_state::ConstPtr& msg)
  {
...
{
  ros::init(argc, argv, "fame_filter_2");
  fame_filter fame;
