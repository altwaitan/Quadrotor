...
public:
  ...
  fame_control()
  {
    sub = n.subscribe<fame::fame_state>("/fame_state_2", 1000, &fame_control::callback, this);
    sub2 = n.subscribe<fame::fame_state>("/fame_trajectory_2", 1000, &fame_control::callback2, this);
    pub = n.advertise<fame::fame_msg>("fame_cmd_2", 1000);
  }
...
{
  ros::init(argc, argv, "fame_control_2");
  fame_control fame;
