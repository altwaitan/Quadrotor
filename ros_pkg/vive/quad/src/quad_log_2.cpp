...
public:
  ...
  quad_log()
  {
    sub = n.subscribe<quad::quad_state_msg>("/quad_trajectory_2", 1000, &quad_log::callback, this);
    sub2 = n.subscribe<quad::quad_state_msg>("/quad_state_2", 1000, &quad_log::callback2, this);
    sub3 = n.subscribe<quad::quad_cmd_msg>("/quad_cmd_2", 1000, &quad_log::callback3, this);
    sub4 = n.subscribe<sensor_msgs::Imu>("/quad_serial_imu_2", 1000, &quad_log::callback4, this);
  }
  ...
  void callback2(const quad::quad_state_msg::ConstPtr& msg)
  {
    ...
    actual.attitude.z = msg->attitude.z; // Yaw angle
  }
...
{
  datafile.open("/home/altwaitan/catkin_ws/src/quad/vehicle2_data.txt");
  ros::init(argc, argv, "quad_log_2");
  quad_log quad;
