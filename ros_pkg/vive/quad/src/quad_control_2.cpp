...
public:
  ...
  quad_control()
  {
    sub = n.subscribe<quad::quad_state_msg>("/quad_state_2", 1000, &quad_control::callback, this);
    sub2 = n.subscribe<quad::quad_state_msg>("/quad_trajectory_2", 1000, &quad_control::callback2, this);
    pub = n.advertise<quad::quad_cmd_msg>("quad_cmd_2", 1000);
  }
...
{
  ros::init(argc, argv, "quad_control_2");
  quad_control quad;
