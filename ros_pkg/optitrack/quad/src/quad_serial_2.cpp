...
public:
  ...
  quad_serial()
  {
    sub = n.subscribe<quad::quad_cmd_msg>("/quad_cmd_2", 1000, &quad_serial::callback, this);
    pub = n.advertise<sensor_msgs::Imu>("quad_serial_imu_2", 1000);
  }
...
{
  ros::init(argc, argv, "quad_serial_node_2");
  quad_serial quad;
