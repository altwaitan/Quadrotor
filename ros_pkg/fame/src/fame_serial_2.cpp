...
public:
  ...
  fame_serial()
  {
    sub = n.subscribe<fame::fame_msg>("/fame_cmd_2", 1000, &fame_serial::callback, this);
    pub = n.advertise<sensor_msgs::Imu>("fame_serial_imu_2", 1000);
  }
...
{
  ros::init(argc, argv, "fame_serial_node_2");
  fame_serial fame;
